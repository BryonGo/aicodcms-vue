          ...
          <div class="icon-selector-warp-title flex">
            ...
            <div class="icon-selector-warp-title-tab" v-if="type === 'all'">
              <span
                ...
                class="ml10"
                :title="$t('message.component.iconfontIcon')"
                >ali</span
              >
              <span
                ...
                class="ml10"
                :title="$t('message.component.elementPlusIcon')"
                >ele</span
              >
              <span
                ...
                class="ml10"
                :title="$t('message.component.fontawesomeIcon')"
                >awe</span
              >
            </div>
          </div>
...
export default defineComponent({
  ...
  props: {
    ...
    placeholder: {
      type: String,
      default: () => i18n.global.t("message.component.iconSearchPlaceholder"),
    },
    // 输入框占位文本
    size: {
      type: String,
    ...
    title: {
      type: String,
      default: () => i18n.global.t("message.component.selectIcon"),
    },
    // icon 图标类型
    type: {
      type: String,
    ...
    emptyDescription: {
      type: String,
      default: () => i18n.global.t("message.component.noIcon"),
    },
