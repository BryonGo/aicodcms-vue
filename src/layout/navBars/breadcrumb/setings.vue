      ...
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
              ...
              :placeholder="$t('message.cms.common.placeholderSelect')"
              size="default"
              style="width: 90px"
              @change="setLocalThemeConfig"
            >
              <el-option :label="$t('message.layoutTagsStyle1')" value="tags-style-one"></el-option>
              <el-option
                :label="$t('message.layoutTagsStyle4')"
                value="tags-style-four"
              ></el-option>
              <el-option
                :label="$t('message.layoutTagsStyle5')"
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            ...
            >
              <el-option
                :label="$t('message.layoutColumnsRound')"
                value="columns-round"
              ></el-option>
              <el-option :label="$t('message.layoutColumnsCard')" value="columns-card"></el-option>
            </el-select>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            ...
            >
              <el-option
                :label="$t('message.layoutColumnsHorizontal')"
                value="columns-horizontal"
              ></el-option>
              <el-option
                :label="$t('message.layoutColumnsVertical')"
  ...
  setup() {
    ...
    const onColorPickerChange = () => {
      if (!getThemeConfig.value.primary)
        return ElMessage.warning(t("message.layoutPrimaryColorRequired"));
      // 颜色加深
    ...
    const onBgColorPickerChange = (bg: string) => {
      document.documentElement.style.setProperty(
        `--next-bg-${bg}`,
        (<any>getThemeConfig.value)[bg],
      );
      if (bg === "menuBar") {
        document.documentElement.style.setProperty(
          `--next-bg-menuBar-light-1`,
          <any>getLightColor(getThemeConfig.value.menuBar, 0.05),
        );
      }
...
<style scoped>
/* ============================================
   Setings Drawer · AICODCMS Design System
   - 旧 SCSS 嵌套 + var(--el-*)/var(--next-*) 全部展平 + 改 --cc-*
   - 抽屉内容布局 / 主题色选 / 布局预览方格 / 复制 & 重置按钮
   ============================================ */
...
.layout-breadcrumb-seting-bar :deep(.el-scrollbar__view) {
...
.layout-drawer-content-item .el-container {
  height: 100%;
}
.layout-drawer-content-item .el-aside-dark {
  background-color: var(--cc-gray-700);
}
.layout-drawer-content-item .el-aside {
  background-color: var(--cc-color-border);
}
.layout-drawer-content-item .el-header {
  background-color: var(--cc-color-border-light);
}
.layout-drawer-content-item .el-main {
  background-color: var(--cc-color-bg);
}

.layout-drawer-content-item .el-circular {
...
.layout-tips-warp-active {
  ...
  border: 1px solid color-mix(in srgb, var(--cc-color-primary) 50%, transparent);
  border-radius: var(--cc-radius-full);
  padding: 4px;
}
.layout-tips-warp .layout-tips-box,
.layout-tips-warp-active .layout-tips-box {
  transition: inherit;
  width: 30px;
  height: 30px;
  z-index: 9;
...
.layout-tips-warp .layout-tips-txt,
.layout-tips-warp-active .layout-tips-txt {
  transition: inherit;
  position: relative;
  top: 5px;
  ...
  letter-spacing: 2px;
  white-space: nowrap;
  color: color-mix(in srgb, var(--cc-color-primary) 50%, transparent);
  text-align: center;
...
.layout-tips-warp-active .layout-tips-txt {
  ...
  background-color: var(--cc-color-bg) !important;
}

/* hover 态 */
.layout-drawer-content-item:hover .el-circular {
  border: 1px solid var(--cc-color-primary);
}
.layout-drawer-content-item:hover .layout-tips-warp {
  border-color: var(--cc-color-primary);
}
.layout-drawer-content-item:hover .layout-tips-warp .layout-tips-box {
  border-color: var(--cc-color-primary);
}
.layout-drawer-content-item:hover .layout-tips-warp .layout-tips-txt {
  color: var(--cc-color-primary) !important;
  background-color: var(--cc-color-bg) !important;
}
