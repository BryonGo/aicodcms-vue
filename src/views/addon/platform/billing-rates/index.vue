  ...
  <div class="pf-page">
    ...
    <div class="pf-filter-card">
      <el-form :inline="true" @submit.prevent>
        <el-form-item :label="$t('message.sdk.platform.filterSite')">
          <el-input v-model="q.siteId" placeholder="siteId" clearable style="width: 160px" @keyup.enter="onQuery" />
        </el-form-item>
    ...
    <div class="pf-table-card">
      ...
      >
        ...
        <el-table-column prop="dimKey" :label="$t('message.sdk.platform.colDimKey')" min-width="140" show-overflow-tooltip />
...
import { getPlatformBillingRates, AdminBillingRateItem } from "/@/api/addon/platform";
...
export default defineComponent({
  ...
  setup() {
    ...
    return { tableData, loading, page, size, total, q, fmtTime, loadData, onQuery, onReset };
  },
});
</script>
